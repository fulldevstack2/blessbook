...
/**
 * The work: hear him, tonight's programme, who books him, and the last door.
 * The night, the man, the record and the instrument are one click away.
 */
  ...
  return (
    ...
    >
      ...
      <section className="nocturne-act">
        <p className="nocturne-eyebrow" data-reveal>
          ACT II <em>·</em> TONIGHT&rsquo;S PROGRAMME
        </p>
        <Programme />
      </section>
 ...
 *
 * Opens on the night that made the record — forty seconds of that sound, then
 * the two firsts stated plainly — and then the man, the record, the instrument
 * and the calling. No curtain: the house has already let you in.
 */
export function NocturneStory() {
  return (
    <Frame>
      {/* ---------------- the night ----------------
      ...
      {/* And then, on a lit page, what the night was: the two claims stated
          ...
          experience of it and this is the record of it. */}
      ...
      {/* The hall itself, filling. The one fact in the record big enough to be
          drawn rather than written — kept with the record, not the films. */}
      <House />
