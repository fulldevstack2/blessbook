...
/**
 * The work: songs, films, who books him, and the commission. The biography, the
 * record and the instrument sit one click away.
 */
  ...
  return (
    ...
    >
      ...
      <section className="dragon-section">
        <Margin index={1} label="In the room" />
        <div>
      ...
      <section className="dragon-section">
        <Margin index={2} label="Who books him" />
        <div>
          <ClientScroll />
      ...
      <section className="dragon-section" id="commission">
        <Margin index={3} label="Commission" />
        <div>
  ...
  return (
    <Frame>
      ...
      <section className="dragon-section dragon-section--invert">
        <Margin index={4} label="The calling" />
        <div>
